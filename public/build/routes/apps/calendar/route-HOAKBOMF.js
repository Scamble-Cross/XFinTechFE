...
import {
  DateRangePicker,
  require_moment
} from "/build/_shared/chunk-BRHXWRHF.js";
import {
  FontAwesomeIcon
...
var require_sweetalert2_all = __commonJS({
  "node_modules/sweetalert2/dist/sweetalert2.all.js"(exports, module) {
    (function(global, factory) {
      ...
      function _classPrivateFieldGet2(s3, a3) {
      ...
      function _classPrivateFieldSet2(s3, a3, r3) {
      ...
      const classNames3 = ["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "show", "hide", "close", "title", "html-container", "actions", "confirm", "deny", "cancel", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error", "draggable", "dragging"];
      const swalClasses = classNames3.reduce(
        (acc, className) => {
...
`;
      ...
      const renderProgressSteps = (instance, params) => {
        ...
        progressSteps.forEach((step, index5) => {
          const stepEl = createStepElement(step);
          progressStepsContainer.appendChild(stepEl);
          if (index5 === currentProgressStep) {
            addClass(stepEl, swalClasses["active-progress-step"]);
          }
          if (index5 !== progressSteps.length - 1) {
      ...
      const setFocus = (index5, increment) => {
        var _dom$getPopup;
        const focusableElements = getFocusableElements();
        if (focusableElements.length) {
          index5 = index5 + increment;
          if (index5 === -2) {
            index5 = focusableElements.length - 1;
          }
          if (index5 === focusableElements.length) {
            index5 = 0;
          } else if (index5 === -1) {
            index5 = focusableElements.length - 1;
          }
          focusableElements[index5].focus();
          return;
        }
      ...
      const argsToParams = (args) => {
        ...
        if (typeof args[0] === "object" && !isElement(args[0])) {
          ...
          ["title", "html", "icon"].forEach((name, index5) => {
      ...
      class EventEmitter {
        ...
        removeListener(eventName, eventHandler) {
          const currentHandlers = this._getHandlersByEventName(eventName);
          const index5 = currentHandlers.indexOf(eventHandler);
          if (index5 > -1) {
            currentHandlers.splice(index5, 1);
          }
        }
        /**
         * @param {string} eventName
    ...
    "undefined" != typeof document && function(e3, t3) {
      var n2 = e3.createElement("style");
      if (e3.getElementsByTagName("head")[0].appendChild(n2), n2.styleSheet)
        n2.styleSheet.disabled || (n2.styleSheet.cssText = t3);
      else
        try {
          n2.innerHTML = t3;
        } catch (e4) {
...
// app/routes/apps/calendar/route.jsx
...
function generateClassNames(classNameGenerator, renderProps) {
  const classNames3 = typeof classNameGenerator === "function" ? classNameGenerator(renderProps) : classNameGenerator || [];
  return typeof classNames3 === "string" ? [classNames3] : classNames3;
}
...
function getEventClassNames(props) {
  let classNames3 = ["fc-event"];
  if (props.isMirror) {
    classNames3.push("fc-event-mirror");
  }
  if (props.isDraggable) {
    classNames3.push("fc-event-draggable");
  }
  if (props.isStartResizable || props.isEndResizable) {
    classNames3.push("fc-event-resizable");
  }
  if (props.isDragging) {
    classNames3.push("fc-event-dragging");
  }
  if (props.isResizing) {
    classNames3.push("fc-event-resizing");
  }
  if (props.isSelected) {
    classNames3.push("fc-event-selected");
  }
  if (props.isStart) {
    classNames3.push("fc-event-start");
  }
  if (props.isEnd) {
    classNames3.push("fc-event-end");
  }
  if (props.isPast) {
    classNames3.push("fc-event-past");
  }
  if (props.isToday) {
    classNames3.push("fc-event-today");
  }
  if (props.isFuture) {
    classNames3.push("fc-event-future");
  }
  return classNames3;
}
...
var CalendarRoot = class extends BaseComponent {
  ...
  render() {
    ...
    if (!getCanVGrowWithinCell()) {
      classNames3.push("fc-liquid-hack");
    }
    return props.children(classNames3, height, isHeightAuto, forPrint);
  }
  componentDidMount() {
...
function getDayClassNames(meta, theme) {
  ...
  if (meta.isDisabled) {
    classNames3.push("fc-day-disabled");
  } else {
    if (meta.isToday) {
      classNames3.push("fc-day-today");
      classNames3.push(theme.getClass("today"));
    }
    if (meta.isPast) {
      classNames3.push("fc-day-past");
    }
    if (meta.isFuture) {
      classNames3.push("fc-day-future");
    }
    if (meta.isOther) {
      classNames3.push("fc-day-other");
    }
  }
  return classNames3;
}
...
var TableDateCell = class extends BaseComponent {
  render() {
    ...
    let classNames3 = [CLASS_NAME].concat(getDayClassNames(dayMeta, theme));
...
function getScrollGridClassNames(liquid, context) {
  ...
  if (liquid) {
    classNames3.push("fc-scrollgrid-liquid");
  }
  return classNames3;
}
function getSectionClassNames(sectionConfig, wholeTableVGrow) {
  ...
  if (wholeTableVGrow && sectionConfig.liquid && sectionConfig.maxHeight == null) {
    classNames3.push("fc-scrollgrid-section-liquid");
  }
  if (sectionConfig.isSticky) {
    classNames3.push("fc-scrollgrid-section-sticky");
  }
  return classNames3;
}
...
var SimpleScrollGrid = class extends BaseComponent {
  ...
  render() {
    ...
    let classNames3 = getScrollGridClassNames(props.liquid, context);
    if (props.collapsibleWidth) {
      classNames3.push("fc-scrollgrid-collapsible");
    }
...
var Popover = class extends BaseComponent {
  ...
  render() {
    ...
    return j3(y(
      "div",
      Object.assign({}, props.extraAttrs, { id: props.id, className: classNames3.join(" "), "aria-labelledby": state.titleId, ref: this.handleRootEl }),
      y(
        "div",
    ...
    return y(ViewContextType.Consumer, null, (context) => {
      ...
      return y(
        ...
        Boolean(props.moreCnt) && y(ContentContainer, {
          ...
          elStyle: props.elStyle,
          elAttrs: Object.assign(Object.assign(Object.assign({}, props.elAttrs), createAriaClickAttrs(this.handleClick)), { title: hint, "aria-expanded": state.isPopoverOpen, "aria-controls": state.isPopoverOpen ? state.popoverId : "" }),
          renderProps,
...
var ViewHarness = class extends BaseComponent {
  ...
  render() {
    ...
    return y("div", { "aria-labelledby": props.labeledById, ref: this.handleEl, className: classNames3.join(" "), style: { height, paddingBottom } }, props.children);
  }
  componentDidMount() {
...
var Calendar = class extends CalendarImpl {
  constructor(el, optionOverrides = {}) {
    ...
    this.handleRenderRequest = () => {
      if (this.isRendering) {
        ...
        flushSync(() => {
          D(y(CalendarRoot, { options: currentData.calendarOptions, theme: currentData.theme, emitter: currentData.emitter }, (classNames3, height, isHeightAuto, forPrint) => {
            this.setClassNames(classNames3);
  ...
  setClassNames(classNames3) {
    if (!isArraysEqual(classNames3, this.currentClassNames)) {
      let { classList } = this.el;
      for (let className of this.currentClassNames) {
        classList.remove(className);
      }
      for (let className of classNames3) {
        classList.add(className);
      }
      this.currentClassNames = classNames3;
    }
  }
  setHeight(height) {
...
var Table = class extends DateComponent {
  ...
  render() {
    ...
    return y(
      "div",
      { ref: this.elRef, className: classNames3.join(" "), style: {
...
function TimeColsAxisCell(props) {
  ...
  return y(ViewContextType.Consumer, null, (context) => {
    if (!props.isLabeled) {
      return y("td", { className: classNames3.join(" "), "data-time": props.isoTimeStr });
    }
    ...
    return y(ContentContainer, { elTag: "td", elClasses: classNames3, elAttrs: {
...
// app/routes/apps/calendar/CalendarSidebar.jsx
var import_react3 = __toESM(require_react(), 1);

// app/routes/apps/calendar/AddCategory.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/AddCategory.jsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1732600247894.246";
}
var AddCategory = ({
  show,
  hide
}) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Modal_default, { show, onHide: hide, size: "sm", centered: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Modal_default.Body, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, { bsPrefix: "btn-close", onClick: hide, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { "aria-hidden": "true", children: "\xD7" }, void 0, false, {
      fileName: "app/routes/apps/calendar/AddCategory.jsx",
      lineNumber: 29,
      columnNumber: 21
    }, this) }, void 0, false, {
      fileName: "app/routes/apps/calendar/AddCategory.jsx",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h6", { className: "text-uppercase fw-bold mb-3", children: "Add Category" }, void 0, false, {
      fileName: "app/routes/apps/calendar/AddCategory.jsx",
      lineNumber: 31,
      columnNumber: 17
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form_default, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Col_default, { sm: 12, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form_default.Control, { type: "text", placeholder: "Category Name" }, void 0, false, {
        fileName: "app/routes/apps/calendar/AddCategory.jsx",
        lineNumber: 36,
        columnNumber: 33
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, { variant: "primary", className: "float-end", onClick: hide, children: "Add" }, void 0, false, {
        fileName: "app/routes/apps/calendar/AddCategory.jsx",
        lineNumber: 40,
        columnNumber: 21
      }, this)
...
// app/routes/apps/calendar/SetReminder.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/SetReminder.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1732600247896.469";
}
var SetReminder = ({
  show,
  hide
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Modal_default, { show, onHide: hide, centered: true, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Modal_default.Body, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button_default, { bsPrefix: "btn-close", onClick: hide, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("span", { "aria-hidden": "true", children: "\xD7" }, void 0, false, {
        fileName: "app/routes/apps/calendar/SetReminder.jsx",
        lineNumber: 30,
        columnNumber: 21
      }, this) }, void 0, false, {
        fileName: "app/routes/apps/calendar/SetReminder.jsx",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h5", { className: "mb-4", children: "Create a Reminder" }, void 0, false, {
        fileName: "app/routes/apps/calendar/SetReminder.jsx",
        lineNumber: 32,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Col_default, { sm: 12, as: Form_default.Group, className: "mb-3", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Col_default, { sm: 12, as: Form_default.Group, className: "mb-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "form-label-group", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Label, { children: "Note/Description" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 43,
              columnNumber: 33
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("small", { className: "text-muted", children: "200" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 44,
              columnNumber: 33
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Control, { as: "textarea", rows: 3 }, void 0, false, {
            fileName: "app/routes/apps/calendar/SetReminder.jsx",
            lineNumber: 46,
            columnNumber: 29
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Row_default, { className: "gx-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Col_default, { sm: 6, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Label, { children: "Start Date" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 52,
              columnNumber: 33
            }, this),
            ...
            }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Control, { type: "text", name: "single-date-pick" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 58,
              columnNumber: 37
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Col_default, { sm: 6, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Label, { children: "Start Time" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 64,
              columnNumber: 33
            }, this),
            ...
            }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Control, { className: "input-timepicker", type: "text", name: "time" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 77,
              columnNumber: 37
            }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Col_default, { sm: 12, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Label, { children: "Remind" }, void 0, false, {
            fileName: "app/routes/apps/calendar/SetReminder.jsx",
            lineNumber: 85,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Form_default.Select, { className: "me-20", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("option", { value: 0, children: "Daily" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 87,
              columnNumber: 37
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("option", { value: 1, children: "Monthly" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 88,
              columnNumber: 37
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("option", { value: 2, children: "Weekly" }, void 0, false, {
              fileName: "app/routes/apps/calendar/SetReminder.jsx",
              lineNumber: 89,
              columnNumber: 37
            }, this)
...
_c2 = SetReminder;
var SetReminder_default = SetReminder;
var _c2;
$RefreshReg$(_c2, "SetReminder");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/routes/apps/calendar/InlineCalendar.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/InlineCalendar.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1732600247896.12";
}
var InlineCalendar = () => {
  _s();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(DateRangePicker, { initialSettings: {
    singleDatePicker: true,
    showDropdowns: false,
    startDate: /* @__PURE__ */ new Date(),
    minYear: 1901,
  ...
  }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Form_default.Control, { id: "single_calendar", type: "text", name: "datetimes", className: "d-none" }, void 0, false, {
    fileName: "app/routes/apps/calendar/InlineCalendar.jsx",
    lineNumber: 38,
    columnNumber: 13
  }, this) }, void 0, false, {
    fileName: "app/routes/apps/calendar/InlineCalendar.jsx",
...
_s(InlineCalendar, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c3 = InlineCalendar;
var InlineCalendar_default = InlineCalendar;
var _c3;
$RefreshReg$(_c3, "InlineCalendar");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/CalendarSidebar.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1732600247894.653";
}
var CalendarSidebar = ({
  createNewEvent
}) => {
  _s2();
  const [addCategory, setAddCategory] = (0, import_react3.useState)(false);
  const [reminder, setReminder] = (0, import_react3.useState)(false);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_jsx_dev_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("nav", { className: "calendarapp-sidebar", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(SimpleBar, { className: "nicescroll-bar", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "menu-content-wrap", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Dropdown_default, { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Dropdown_default.Toggle, { variant: "primary", className: "btn-rounded btn-block", children: "Create" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
            lineNumber: 41,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Dropdown_default.Menu, { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Dropdown_default.Item, { onClick: createNewEvent, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { children: "Create an Event" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 47,
                columnNumber: 37
              }, this)
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Dropdown_default.Item, { onClick: () => setReminder(!reminder), children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { className: "feather-icon dropdown-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(bell_default, {}, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 51,
                columnNumber: 41
              }, this) }, void 0, false, {
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { children: "Set a Reminder" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 53,
                columnNumber: 37
              }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "text-center mt-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { id: "inline_calendar", className: "d-inline-block", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(InlineCalendar_default, {}, void 0, false, {
          fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
          lineNumber: 59,
          columnNumber: 33
        }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "title-sm text-primary", children: "Upcoming Events" }, void 0, false, {
          fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
          lineNumber: 63,
          columnNumber: 25
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "upcoming-event-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default, { as: "ul", className: "nav-light navbar-nav flex-column", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default.Item, { as: "li", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default.Link, { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "d-flex align-items-center", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Badge_default, { bg: "violet", className: "badge-indicator badge-indicator-lg me-2" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 69,
                columnNumber: 45
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { className: "event-time", children: "Today, 5:00 onwards" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 70,
                columnNumber: 45
              }, this)
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "event-name", children: "Jampack Team Meet" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
              lineNumber: 72,
              columnNumber: 41
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default.Item, { as: "li", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default.Link, { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "d-flex align-items-center", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { className: "event-time", children: "Tomorrow, 2:35 PM" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 79,
                columnNumber: 45
              }, this)
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "event-name", children: "Indigo Flight to Indonesia" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
              lineNumber: 81,
              columnNumber: 41
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default.Item, { as: "li", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default.Link, { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "d-flex align-items-center", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Badge_default, { bg: "warning", className: "badge-indicator badge-indicator-lg me-2" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 87,
                columnNumber: 45
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { className: "event-time", children: "24 Jul, 9:30 AM" }, void 0, false, {
                fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
                lineNumber: 88,
                columnNumber: 45
              }, this)
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "event-name", children: "Awwwards Conference" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
              lineNumber: 90,
              columnNumber: 41
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "categories-wrap", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Form_default.Check, { id: "customChecksc1", type: "checkbox", label: "Meetings", defaultChecked: true }, void 0, false, {
            fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
            lineNumber: 107,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Form_default.Check, { id: "customChecksc2", type: "checkbox", label: "Flights", defaultChecked: true }, void 0, false, {
            fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
            lineNumber: 108,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Form_default.Check, { id: "customChecksc3", type: "checkbox", label: "Birthday", defaultChecked: true }, void 0, false, {
            fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
            lineNumber: 109,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Form_default.Check, { id: "customChecksc4", type: "checkbox", label: "Conferences" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
            lineNumber: 110,
            columnNumber: 29
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "calendarapp-fixednav", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "hk-toolbar", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Nav_default, { className: "nav-light", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(AddCategory_default, { show: addCategory, hide: () => setAddCategory(!addCategory) }, void 0, false, {
      fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
      lineNumber: 157,
      columnNumber: 13
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(SetReminder_default, { show: reminder, hide: () => setReminder(!reminder) }, void 0, false, {
      fileName: "app/routes/apps/calendar/CalendarSidebar.jsx",
      lineNumber: 159,
      columnNumber: 13
    }, this)
...
_s2(CalendarSidebar, "wTU+Mg969Soz2C9QwOHIviPFe1s=");
_c4 = CalendarSidebar;
var CalendarSidebar_default = CalendarSidebar;
var _c4;
$RefreshReg$(_c4, "CalendarSidebar");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/routes/apps/calendar/Events.jsx
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1732600247895.308";
}
var curYear = (0, import_moment.default)().format("YYYY");
var curMonth = (0, import_moment.default)().format("MM");
var CalendarEvents = [
  {
...
// app/routes/apps/calendar/EventsDrawer.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/EventsDrawer.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var EventsDrawer = ({
  ...
  _s3();
  const [editable, setEditable] = (0, import_react4.useState)(false);
  const [eventColor, setEventColor] = (0, import_react4.useState)("#009B84");
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: (0, import_classnames.default)("hk-drawer calendar-drawer drawer-right", {
    "drawer-toggle": show
  }), style: {
    border: "none",
    boxShadow: "0 8px 32px rgba(0, 0, 0, 0.1)"
  }, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: (0, import_classnames.default)({
      "d-none": editable
    }), children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-header", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-header-action", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { size: "sm", variant: "flush-secondary", id: "edit_event", className: "btn-icon btn-rounded flush-soft-hover", onClick: () => setEditable(!editable), children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(edit_2_default, {}, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 116,
          columnNumber: 37
        }, this) }, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { size: "sm", variant: "flush-secondary", id: "del_event", className: "btn-icon btn-rounded flush-soft-hover", onClick: DeletEvent, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(trash_2_default, {}, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 123,
          columnNumber: 37
        }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { size: "sm", variant: "flush-secondary", className: "btn-icon btn-rounded flush-soft-hover me-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(external_link_default, {}, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 130,
          columnNumber: 37
        }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { bsPrefix: "btn-close", className: "drawer-close", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { "aria-hidden": "true", children: "\xD7" }, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 135,
          columnNumber: 29
        }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-body", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SimpleBar, { className: "nicescroll-bar", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-content-wrap", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "event-head mb-4", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_badge_default, { bg: "violet", indicator: true, className: "badge-indicator-xl flex-shrink-0 me-2" }, void 0, false, {
            fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
            lineNumber: 143,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "event-name", children: info }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 145,
              columnNumber: 37
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { children: "Event" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 146,
              columnNumber: 37
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("ul", { className: "event-detail", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(calendar_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 153,
              columnNumber: 45
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(clock_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 161,
              columnNumber: 45
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(map_pin_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 169,
              columnNumber: 45
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(check_square_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 177,
              columnNumber: 45
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(eye_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 185,
              columnNumber: 45
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(user_plus_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 193,
              columnNumber: 45
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "d-flex flex-wrap", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_chips_default, { variant: "primary", src: avatar11_default, className: "mb-2 me-2", children: "Morgan" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 197,
                columnNumber: 41
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_chips_default, { variant: "primary", src: avatar12_default, className: "mb-2 me-2", children: "Charlie" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 198,
                columnNumber: 41
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_chips_default, { variant: "primary", src: avatar13_default, className: "mb-2 me-2", children: "Winston" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 199,
                columnNumber: 41
              }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "ev-icon-wrap", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(menu_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 205,
              columnNumber: 45
            }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: (0, import_classnames.default)({
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-header", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-header-action", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { bsPrefix: "btn-close", className: "drawer-close", onClick: handleClose, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { "aria-hidden": "true", children: "\xD7" }, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 228,
          columnNumber: 29
        }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-body", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SimpleBar, { className: "nicescroll-bar", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-content-wrap", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "event-head mb-4", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { id: "editableContent", contentEditable: "true", suppressContentEditableWarning: true, className: "event-name", children: info }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 238,
              columnNumber: 37
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mt-2 mb-0", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Check, { inline: true, label: "Event", name: "group1", type: "radio", id: "radio-1", defaultChecked: true }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 240,
                columnNumber: 41
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Check, { inline: true, label: "Reminder", name: "group1", type: "radio", id: "radio-2" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 242,
                columnNumber: 41
              }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default, { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-affix-wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-prefix", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(calendar_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 253,
              columnNumber: 53
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(DateRangePicker, { initialSettings: {
              timePicker: true,
              startDate: (0, import_moment2.default)().startOf("hour").toDate(),
              endDate: (0, import_moment2.default)().startOf("hour").add(32, "hour").toDate(),
              locale: {
                format: "M/DD hh:mm A"
              }
            }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { type: "text", name: "datetimes" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 265,
              columnNumber: 49
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-affix-wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-prefix", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(clock_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 275,
              columnNumber: 53
            }, this) }, void 0, false, {
            ...
            }, onShow: hideCalender, children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { className: "input-timepicker", type: "text", name: "time" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 288,
              columnNumber: 49
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-affix-wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-prefix", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(map_pin_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 298,
              columnNumber: 53
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { type: "text", className: "form-wth-icon", defaultValue: "Oslo, Canada" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 301,
              columnNumber: 45
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-affix-wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-prefix", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(check_square_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 310,
              columnNumber: 53
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Select, { children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("option", { value: 1, children: "All Time" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 314,
                columnNumber: 49
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("option", { value: 2, children: "Half Day" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 315,
                columnNumber: 49
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("option", { value: 3, children: "9 to 5" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 316,
                columnNumber: 49
              }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-affix-wrapper", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "input-prefix", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("span", { className: "feather-icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(eye_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 326,
              columnNumber: 53
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Select, { children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("option", { value: 0, children: "Default Visibility" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 330,
                columnNumber: 49
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("option", { value: 1, children: "Private" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 331,
                columnNumber: 49
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("option", { value: 2, children: "Public" }, void 0, false, {
                fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
                lineNumber: 332,
                columnNumber: 49
              }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default, { className: "color-picker", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(InputGroup_default.Text, { className: "colorpicker-input-addon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { type: "color", id: "exampleColorInput", title: "Choose your color", value: eventColor, onChange: (e3) => setEventColor(e3.target.value) }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 340,
              columnNumber: 45
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { type: "text", value: eventColor, onChange: () => setEventColor(eventColor) }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 343,
              columnNumber: 41
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "d-flex flex-wrap", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_chips_default, { variant: "primary", src: avatar11_default, dismissable: true, className: "mb-2 me-2", children: "Morgan" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 348,
              columnNumber: 41
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_chips_default, { variant: "primary", src: avatar12_default, dismissable: true, className: "mb-2 me-2", children: "Charlie" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 349,
              columnNumber: 41
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(hk_chips_default, { variant: "primary", src: avatar13_default, dismissable: true, className: "mb-2 me-2", children: "Winston" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 350,
              columnNumber: 41
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { type: "text", className: "border-0 p-0 shadow-none flex-1 mb-2 me-2" }, void 0, false, {
              fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
              lineNumber: 351,
              columnNumber: 41
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Form_default.Control, { as: "textarea", rows: 4, defaultValue: "Annual meeting with global branch teams & bosses about growth planning and fiscal year reports" }, void 0, false, {
            fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
            lineNumber: 355,
            columnNumber: 37
          }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "drawer-footer d-flex justify-content-end", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { variant: "secondary", className: "drawer-edit-close me-2", onClick: () => setEditable(!editable), children: "discard" }, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 362,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(Button_default, { variant: "primary", className: "drawer-edit-close", onClick: () => setEditable(!editable), children: "save" }, void 0, false, {
          fileName: "app/routes/apps/calendar/EventsDrawer.jsx",
          lineNumber: 363,
          columnNumber: 21
        }, this)
...
_s3(EventsDrawer, "SSHIj8e7N0BoXTf5w/Q+qBeobXo=");
_c5 = EventsDrawer;
var EventsDrawer_default = EventsDrawer;
var _c5;
$RefreshReg$(_c5, "EventsDrawer");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/routes/apps/calendar/CreateNewEvent.jsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/CreateNewEvent.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1732603406375.266";
}
var CreateNewEvent = ({
  show,
  hide,
  ...
  const [start, setStart] = (0, import_react5.useState)(/* @__PURE__ */ new Date());
  const [end, setEnd] = (0, import_react5.useState)(/* @__PURE__ */ new Date());
  const [backgroundColor, setBackgroundColor] = (0, import_react5.useState)("#009B84");
  const updateEventList = (e3) => {
    e3.preventDefault();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Modal_default, { show, onHide: hide, size: "lg", centered: true, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Modal_default.Body, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Button_default, { bsPrefix: "btn-close", onClick: hide, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("span", { "aria-hidden": "true", children: "\xD7" }, void 0, false, {
        fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
        lineNumber: 53,
        columnNumber: 21
      }, this) }, void 0, false, {
        fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("h5", { className: "mb-4", children: "Create New Event" }, void 0, false, {
        fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
        lineNumber: 55,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 12, as: Form_default.Group, className: "mb-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "Name" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 59,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { className: "cal-event-name", type: "text", value: title, onChange: (e3) => setTitle(e3.target.value) }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 60,
            columnNumber: 29
          }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 12, as: Form_default.Group, className: "mb-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "form-label-group", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "Note/Description" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 66,
              columnNumber: 33
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("small", { className: "text-muted", children: "200" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 67,
              columnNumber: 33
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 6, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            ...
            }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { type: "text", name: "single-date-pick1" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 83,
              columnNumber: 37
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 6, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "Start Time" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 89,
              columnNumber: 33
            }, this),
            ...
            }, onShow: hideCalender, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { className: "input-timepicker", type: "text", name: "time" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 100,
              columnNumber: 37
            }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 6, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            ...
            }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { type: "text", name: "single-date-pick2" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 116,
              columnNumber: 37
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 6, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "End Time" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 122,
              columnNumber: 33
            }, this),
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 12, children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "Location" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 140,
            columnNumber: 29
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { type: "text" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 142,
            columnNumber: 33
          }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 5, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "Category" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 149,
              columnNumber: 33
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { type: "text" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 150,
              columnNumber: 33
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 7, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mb-3", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { children: "Visibility" }, void 0, false, {
              fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
              lineNumber: 155,
              columnNumber: 33
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "d-flex", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Select, { className: "me-3", children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("option", { value: 1, children: "Public" }, void 0, false, {
                  fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
                  lineNumber: 158,
                  columnNumber: 41
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("option", { value: 2, children: "Private" }, void 0, false, {
                  fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
                  lineNumber: 159,
                  columnNumber: 41
                }, this)
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(InputGroup_default, { className: "color-picker w-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("span", { className: "input-group-text colorpicker-input-addon rounded-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Control, { type: "color", id: "exampleColorInput", value: backgroundColor, title: "Choose your color", onChange: (e3) => setBackgroundColor(e3.target.value) }, void 0, false, {
                fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
                lineNumber: 163,
                columnNumber: 45
              }, this) }, void 0, false, {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Row_default, { className: "gx-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Col_default, { sm: 12, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Group, { className: "mt-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Label, { className: "me-3", children: "Set priority:" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 173,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Check, { inline: true, label: "Urgent", name: "group1", type: "radio", id: "urgent", defaultChecked: true }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 174,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Check, { inline: true, label: "High", name: "group1", type: "radio", id: "high" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 175,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Check, { inline: true, label: "Low", name: "group1", type: "radio", id: "low" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 176,
            columnNumber: 33
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Form_default.Check, { inline: true, label: "Medium", name: "group1", type: "radio", id: "medium" }, void 0, false, {
            fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
            lineNumber: 177,
            columnNumber: 33
          }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Modal_default.Footer, { className: "align-items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Button_default, { variant: "secondary", onClick: hide, children: "Discard" }, void 0, false, {
        fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
        lineNumber: 184,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Button_default, { variant: "primary", className: "fc-addEventButton-button", onClick: updateEventList, children: "Add" }, void 0, false, {
        fileName: "app/routes/apps/calendar/CreateNewEvent.jsx",
        lineNumber: 185,
        columnNumber: 17
      }, this)
...
_s4(CreateNewEvent, "HWvmaRLQVRsKJlbUU58DzGpBJgM=");
_c6 = CreateNewEvent;
var CreateNewEvent_default = CreateNewEvent;
var _c6;
$RefreshReg$(_c6, "CreateNewEvent");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/apps/calendar/route.jsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var Calendar2 = () => {
  _s5();
  let calendarRef = (0, import_react6.createRef)();
  var curYear2 = (0, import_moment3.default)().format("YYYY"), curMonth2 = (0, import_moment3.default)().format("MM");
  const {
    states,
    dispatch
  } = useGlobalStateContext();
  const [showSidebar, setShowSidebar] = (0, import_react6.useState)(true);
  const [showEventInfo, setShowEventInfo] = (0, import_react6.useState)(false);
  const [createEvent, setCreateEvent] = (0, import_react6.useState)(false);
  const [eventTitle, setEventTitle] = (0, import_react6.useState)();
  const [targetEvent, setTargetEvent] = (0, import_react6.useState)();
  const [date, setDate] = (0, import_react6.useState)(curYear2 + "-" + curMonth2 + "-07");
  const [currentView, setCurrentView] = (0, import_react6.useState)("month");
  (0, import_react6.useEffect)(() => {
    const calApi = calendarRef.current.getApi();
    if (calApi) {
      setDate((0, import_moment3.default)(calApi.getDate()));
    }
  }, []);
  const handleChange = (action) => {
    ...
    if (calendarApi) {
      ...
      setDate((0, import_moment3.default)(calendarApi.getDate()));
    }
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(import_jsx_dev_runtime7.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "hk-pg-body py-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: (0, import_classnames2.default)("calendarapp-wrap", {
      "calendarapp-sidebar-toggle": !showSidebar
    }), children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(CalendarSidebar_default, { createNewEvent: () => setCreateEvent(!createEvent) }, void 0, false, {
        fileName: "app/routes/apps/calendar/route.jsx",
        lineNumber: 110,
        columnNumber: 21
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "calendarapp-content", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { id: "calendar", className: "w-100 d-flex flex-column", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("header", { className: "cd-header", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "d-flex flex-1 justify-content-start", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "outline-light me-3", onClick: () => handleChange("today"), children: "Today" }, void 0, false, {
              fileName: "app/routes/apps/calendar/route.jsx",
              lineNumber: 116,
              columnNumber: 37
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "flush-dark", className: "btn-icon btn-rounded flush-soft-hover", onClick: () => handleChange("prev"), children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("span", { className: "icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(FontAwesomeIcon, { icon: faChevronLeft, size: "sm" }, void 0, false, {
              fileName: "app/routes/apps/calendar/route.jsx",
              lineNumber: 119,
              columnNumber: 45
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "flush-dark", className: "btn-icon btn-rounded flush-soft-hover", onClick: () => handleChange("next"), children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("span", { className: "icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(FontAwesomeIcon, { icon: faChevronRight, size: "sm" }, void 0, false, {
              fileName: "app/routes/apps/calendar/route.jsx",
              lineNumber: 124,
              columnNumber: 45
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "d-flex flex-1 justify-content-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("h4", { className: "mb-0", children: (0, import_moment3.default)(date).format("MMMM YYYY") }, void 0, false, {
            fileName: "app/routes/apps/calendar/route.jsx",
            lineNumber: 129,
            columnNumber: 37
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "cd-options-wrap d-flex flex-1 justify-content-end", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(ButtonGroup_default, { className: "d-none d-md-flex", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "outline-light", onClick: () => handleView("month"), active: currentView === "month", children: "month" }, void 0, false, {
                fileName: "app/routes/apps/calendar/route.jsx",
                lineNumber: 133,
                columnNumber: 41
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "outline-light", onClick: () => handleView("week"), active: currentView === "week", children: "week" }, void 0, false, {
                fileName: "app/routes/apps/calendar/route.jsx",
                lineNumber: 134,
                columnNumber: 41
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "outline-light", onClick: () => handleView("day"), active: currentView === "day", children: "day" }, void 0, false, {
                fileName: "app/routes/apps/calendar/route.jsx",
                lineNumber: 135,
                columnNumber: 41
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { variant: "outline-light", onClick: () => handleView("list"), active: currentView === "list", children: "list" }, void 0, false, {
                fileName: "app/routes/apps/calendar/route.jsx",
                lineNumber: 136,
                columnNumber: 41
              }, this)
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Button_default, { as: "a", variant: "flush-dark", className: "btn-icon btn-rounded flush-soft-hover hk-navbar-togglable", onClick: () => dispatch({
              type: "top_nav_toggle"
            }), children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("span", { className: "icon", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("span", { className: "feather-icon", children: states.layoutState.topNavCollapse ? /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(chevron_down_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/route.jsx",
              lineNumber: 143,
              columnNumber: 86
            }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(chevron_up_default, {}, void 0, false, {
              fileName: "app/routes/apps/calendar/route.jsx",
              lineNumber: 143,
              columnNumber: 104
            }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: (0, import_classnames2.default)("hk-sidebar-togglable", {
            "active": !showSidebar
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(FullCalendar, { ref: calendarRef, plugins: [index, index2, index3, index4], initialView: "dayGridMonth", initialDate: date, headerToolbar: false, themeSystem: "bootstrap", height: Calender_height - 130, windowResizeDelay: 500, droppable: true, editable: true, events: CalendarEvents, eventClick: function(info) {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(EventsDrawer_default, { show: showEventInfo, info: eventTitle, event: targetEvent, onClose: () => setShowEventInfo(!showEventInfo) }, void 0, false, {
      fileName: "app/routes/apps/calendar/route.jsx",
      lineNumber: 167,
      columnNumber: 13
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(CreateNewEvent_default, { calendarRef, show: createEvent, hide: () => setCreateEvent(!createEvent) }, void 0, false, {
      fileName: "app/routes/apps/calendar/route.jsx",
      lineNumber: 170,
      columnNumber: 13
    }, this)
...
_s5(Calendar2, "Rgsq0eJz3pTWRHWV1XobHXXiOhs=", false, function() {
  return [useGlobalStateContext, useWindowHeight];
});
_c7 = Calendar2;
var route_default = Calendar2;
var _c7;
...
sweetalert2/dist/sweetalert2.all.js:
  ...
  *)
*/
//# sourceMappingURL=/build/routes/apps/calendar/route-HOAKBOMF.js.map
