  ...
  routes(defineRoutes) {
    return defineRoutes((route) => {
      ...
      route("/", "layout/app-layout/index.jsx", () => {
        ...
        route("/analysis/company", "routes/apps/analysis/company/index.jsx");
        route("/analysis/gold", "routes/apps/analysis/gold/index.jsx");
        route("/analysis/major", "routes/apps/analysis/major/index.jsx");
        ...
        route(
          "/apps/chat-popup/direct-message",
          "routes/apps/chat-popup/direct-message/route.jsx"
        );
        route(
          "/apps/chat-popup/chat-bot",
          "routes/apps/chat-popup/chat-bot/route.jsx"
        );
        route("/apps/calendar", "routes/apps/calendar/route.jsx");
        route("/apps/email", "routes/apps/email/route.jsx");
        route(
          "/apps/scrumboard/project-board",
          "routes/apps/scrumboard/project-board/route.jsx"
        );
        route(
          "/apps/scrumboard/kanban-board",
          "routes/apps/scrumboard/kanban-board/route.jsx"
        );
        route(
          "/apps/scrumboard/pipeline",
          "routes/apps/scrumboard/pipeline/route.jsx"
        );
        route(
          "/apps/contact/contact-list",
          "routes/apps/contact/contact-list/route.jsx"
        );
        route(
          "/apps/contact/contact-cards",
          "routes/apps/contact/contact-cards/route.jsx"
        );
        route(
          "/apps/contact/edit-contact",
          "routes/apps/contact/edit-contact/route.jsx"
        );
        route(
          "/apps/file-manager/",
          "routes/apps/file-manager/route.jsx",
          () => {
            route("list-view", "routes/apps/file-manager/list-view/route.jsx", {
              index: true,
            });
        ...
        route(
          ...
          "routes/apps/invoices/invoice-list/route.jsx"
        );
        route(
          "/apps/invoices/invoice-templates",
          "routes/apps/invoices/invoice-templates/route.jsx"
        );
        route(
          "/apps/invoices/create-invoice",
          "routes/apps/invoices/create-invoice/route.jsx"
        );
        route(
          "/apps/invoices/invoice-preview",
          "routes/apps/invoices/invoice-preview/route.jsx"
        );
        route(
          "/apps/integrations/all-apps",
          "routes/apps/integrations/all-apps/route.jsx"
        );
        route(
          "/apps/integrations/app-detail",
          "routes/apps/integrations/app-detail/route.jsx"
        );
        route(
          "/apps/integrations/integration",
          "routes/apps/integrations/integration/route.jsx"
        );
        //Profile
        route("/profile", "routes/apps/profile/route.jsx");
        route(
          "/profile/edit-profile",
          "routes/apps/profile/edit-profile/route.jsx"
        );
