...
const ModalChart = () => {
  ...
  useEffect(() => {
    ...
    const option = {
      ...
      color: [
        "#1565C0", // Bất động sản
        "#FB8C00", // Chăm sóc sức khỏe
        "#9E9E9E", // Công nghệ thông tin
        "#FDD835", // Công nghiệp
        "#5E35B1", // Dịch vụ tiện ích
        "#33691E", // Dịch vụ viễn thông
        "#0D47A1", // Năng lượng
        "#6D4C41", // Nguyên vật liệu
        "#212121", // Tài chính
        "#283593", // Tiêu dùng không thiết yếu
        "#9FA8DA", // Tiêu dùng thiết yếu
      ],
      yAxis: {
        type: "value",
        min: 0,
