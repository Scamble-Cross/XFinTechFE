        ...
        <Navbar expand="xl" className="hk-navbar navbar-light fixed-top" >
            <Container fluid>
                ...
                <div className="nav-start-wrap">
                    <Button variant="flush-dark" className="btn-icon btn-rounded flush-soft-hover navbar-toggle d-xl-none" onClick={() => dispatch({ type: 'sidebar_toggle', sidebarCollapse: !states.sidebarCollapse })}>
                        <span className="icon">
                ...
                <div className="nav-end-wrap">
                    <Nav className="navbar-nav flex-row">
                        <Nav.Item>
                            <Button as={Link} variant="flush-dark" to="/apps/email" className="btn-icon btn-rounded flush-soft-hover">
                                <span className="icon">
