      ...
      <Container fluid>
        ...
        <div className="nav-start-wrap flex-fill">
          ...
          <Link
            to="/dashboard"
            prefetch="intent"
            className="navbar-brand d-xl-flex d-none"
          >
            VSMI
            <span>Vietnam Stock Market Insight</span>
          ...
          <Button
            ...
            className="btn-icon btn-rounded btn-flush-dark flush-soft-hover navbar-toggle d-xl-none"
          >
            <span className="icon">
